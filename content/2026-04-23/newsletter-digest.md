...
date: 2026-04-23
type: newsletter
title: "Newsletter digest — 23 April 2026"
period_start: 2026-04-16
period_end: 2026-04-23
sources_cited: 3
editor_note: "First real newsletter digest after the 2026-04-22 seed sample. Direct RSS and landing-page fetches were blocked in this run (403 on every newsletter), so selection relied on web search and per-post URL verification. Three in-window items confirmed across Transformer, Import AI, and the EU AI Act Newsletter. Several core newsletters could not be verified to have published in the 16–23 April window and are logged as such in the body and completion summary; next week's digest should revisit them directly."
---

## Transformer

### Anthropic's donations can't be used to influence elections — despite what everyone thought 🆕 NEW
...
### EU AI Act Newsletter #100: The European Way 🆕 NEW
- **URL:** https://artificialintelligenceact.substack.com/p/the-eu-ai-act-newsletter-100-the
- **Published:** 2026-04-20 (approximate; confirmed "~3 days ago" as of 23 April)
- **Stage:** trilogue
- **Why it matters:** Risto Uuk's 100th issue locks in the AI Act Omnibus trilogue calendar: second political trilogue on 28 April, IMCO/LIBE committee vote in May, plenary vote in June, Official Journal publication in July — just days before high-risk obligations take effect on 2 August 2026. That is the decisive fortnight for influencing the Omnibus compromise text; after late April the corridor narrows sharply. The issue also frames Commissioner Virkkunen's one-year review of the AI Continent Action Plan (19 AI Factories deployed, 76 Gigafactory expressions of interest), which is the political backdrop the Commission will lean on to justify simplification.
